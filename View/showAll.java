...
public class showAll {
	...
	{
		//for menu show icons of home and logout and tool tip
    ...
    void showSection(ActionEvent event) 
	{
		...
		try 
		{	//we will show details by what the user chose
		...
		else if(comboFilter.getValue().equals("Name"))
		{
			arr.sort(new Comparator<Snack>() 
			{
				...
				public int compare(Snack o1, Snack o2) 
				{
					...
					{
						return o1.getId() - o2.getId(); // second by id
					}
		...
		else if(comboFilter.getValue().equals("Bar"))
		{
			arr.sort(new Comparator<Snack>() 
			{
				...
				public int compare(Snack o1, Snack o2) 
				{
					...
					return o1.getBar().getId() - o2.getBar().getId(); // compare by bar
				}
		...
		else if(comboFilter.getValue().equals("type"))
		{
			arr.sort(new Comparator<Snack>() 
			{
				...
				public int compare(Snack o1, Snack o2) 
				{
					...
					return o1.getType().compareTo(o2.getType()); // compare by Type
				}
		...
		{	
			...
			if(myComboBox.getValue().equals("Sections"))
			{
				...
				if(comboFilter.getValue().equals("Capacity"))
				{
					...
					{
						if(se.getMaxCapacity()>=minimum && se.getMaxCapacity()<=maximum) // if the max capacity between min and max
						{
				...
				else if(comboFilter.getValue().equals("Revnues"))
				{
					for(Section se : allSections)
					{
						if(se.getTodayRevenue()>=minimum && se.getTodayRevenue()<=maximum) // if the revenue between min and max
						{
							filterSection.add(se);
						}
					}
				...
				else if(comboFilter.getValue().equals("Number of Employees now"))
				{
					...
					for(Section se : allSections)
					{
						...
						if(employeesNumber>=minimum && employeesNumber<=maximum) // if the number of employees between min and max
						{
							filterSection.add(se);
						}
					}
				...
				else if(comboFilter.getValue().equals("Number of Visitors now"))
				{
					...
					for(Section se : allSections)
					{
						...
						if(visitorsNumber>=minimum && visitorsNumber<=maximum) // if the number of employees between min and max
						{
							filterSection.add(se);
						}
					}
