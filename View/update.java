...
public class update {
			...
			if(comboBoxField.getValue().equals("birthDay"))
			{
				dp.setDayCellFactory(picker -> new DateCell() {
			        public void updateItem(LocalDate date, boolean empty) {
			            ...
			            LocalDate maxDate;
			            //because employee or visitor needs to be at least 3
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
	 //This method will update if something which is (string) text update
	...
	try {
		 if(textNew.isVisible())
		 {
			...
			/////////////////////////////////////////////////////////////////////////////////////
			 ...
			 ///////////////////////////////////////////////////////////////////////////////////
			 if(myClass.equals("Drink")||myClass.equals("Food")) 
			 {
				 try {					 				
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //this method will show alert that the update is succeed
